...
using HappyTravel.Hiroshima.DbData.Models.Booking;
...
using Room = HappyTravel.Hiroshima.DbData.Models.Room.Room;
    ...
    public class DirectContractsDbContext : DbContext
    {
        ...
        private void AddLocations(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Models.Location.Location>(e =>
            {
                ...
                e.HasOne<Country>().WithMany().HasForeignKey(l=> l.CountryCode).IsRequired();
            });
        }
