...
namespace HappyTravel.Hiroshima.DirectManager.Services
{
    public interface IAllocationRequirementManagementService
    {
        ...
        Task<Result<Models.Responses.AllocationRequirement>> Modify(int contractId, int allocationRequirementId, Models.Requests.AllocationRequirement allocationRequirement);
