...
namespace HappyTravel.Hiroshima.DirectManager.RequestValidators
{
    public class OccupancyDefinitionValidator : AbstractValidator<OccupancyDefinition>
    {
        public OccupancyDefinitionValidator()
        {
            ...
            RuleFor( od => od.Adult).Must(ar => ar != null && ar.Value.LowerBound > 12 && IsValidAgeRange(ar.Value)).WithMessage(string.Format(errorMessage, nameof(OccupancyDefinition.Adult), nameof(OccupancyDefinition)));
