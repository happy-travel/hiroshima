...
{
    public class DcCancellationPoliciesService: IDcCancellationPoliciesService
    {
        public List<CancellationPolicyDetails> Get(RoomCancellationPolicy roomCancellationPolicy, DateTime checkInDate, PaymentDetails paymentDetails)
        {
            ...
            var cancellationPolicyData = roomCancellationPolicy.CancellationPolicyData;
        ...
        => MoneyCeiler.Ceil(paymentDetails.TotalPrice * Convert.ToDecimal(percentCharge) / 100, paymentDetails.Currency);
