...
{
    public class DcRoomAvailabilityService: IDcRoomAvailabilityService
    {
        public DcRoomAvailabilityService(DcDbContext dbContext)
        {
            _dbContext = dbContext;
        }
        

        public async Task<List<RoomsGroupedByOccupation>> GetGroupedRooms(List<AccommodationWithLocation> accommodations,
