...
{
    public class DirectContractsLocationService : IDirectContractsLocationService
    {
        public DirectContractsLocationService(DirectContractsDbContext dbContext, IOptions<JsonOptions> jsonOptions)
        {
