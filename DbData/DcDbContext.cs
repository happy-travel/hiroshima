using System;
using Hiroshima.DbData.Infrastucture.Extensions;
    ...
    public class DcDbContext : DbContext
    {
        ...
        private void AddRates(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Rate>(e =>
            {
                ...
                e.Property(a => a.Price).HasColumnType("jsonb");
        ...
        private void AddPermittedOccupancies(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PermittedOccupancy>(e =>
            {
                ...
                e.Property(p => p.AdultsCount).HasDefaultValue(0);
                e.Property(p => p.ChildrenCount).HasDefaultValue(0);
        ...
        private readonly DbContextOptions<DcDbContext> _options;
